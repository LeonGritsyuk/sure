  ...
  def import_col_label(key)
    {
      ...
      exchange_rate: I18n.t("imports.column_labels.exchange_rate"),
      exchange_rate_from: I18n.t("imports.column_labels.exchange_rate_from"),
      exchange_rate_to: I18n.t("imports.column_labels.exchange_rate_to"),
